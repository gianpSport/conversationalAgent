...
public class DM046 extends DM000{
	
	String url = DM_AllTests.URL;
	float threshold = DM_AllTests.threshold;
	DialogManager dm;
	String message="avete capsule solo per il caffè oppure anche the e caffè d'orzo?";
	String result_message="{\"query\":{\"name\":\"text\",\"category\":\"extracted\",\"token\":\"solo\"}}{\"query\":{\"domain\":{\"name\":\"capsule\",\"property\":{\"name\":\"composition\",\"category\":\"property\",\"value\":{\"name\":\"tea\",\"category\":\"value\",\"token\":\"the\"}},\"category\":\"domain\",\"token\":\"capsule\"},\"name\":\"search\",\"category\":\"action\",\"token\":\"avete\"}}{\"result\":{\"name\":\"lavazza orzo\"},\"query\":{\"domain\":{\"name\":\"capsule\",\"property\":{\"name\":\"composition\",\"category\":\"property\",\"value\":{\"name\":\"barley\",\"category\":\"value\",\"token\":\"orzo\"}},\"category\":\"domain\",\"token\":\"capsule\"},\"name\":\"search\",\"category\":\"action\",\"token\":\"avete\"}}{\"query\":{\"name\":\"text\",\"category\":\"extracted\",\"token\":\"anche\"}}";
