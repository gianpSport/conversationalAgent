...
public class DM054 extends DM000{
	
	String url = DM_AllTests.URL;
	float threshold = DM_AllTests.threshold;
	DialogManager dm;
	String message="qual è il caffè più economico?";
	String result_message="{\"result\":[{\"name\":\"lavazza qualità rossa\"},{\"name\":\"lavazza passionale\"},{\"name\":\"lavazza soave\"},{\"name\":\"lavazza intenso\"},{\"name\":\"lavazza deck cremoso\"},{\"name\":\"lavazza delizioso\"},{\"name\":\"lavazza dolce\"}],\"query\":{\"domain\":{\"name\":\"capsule\",\"property\":{\"name\":\"cheap\",\"category\":\"property\",\"value\":{\"name\":\"true_cheap\",\"category\":\"value\",\"token\":\"più economic\"}},\"category\":\"domain\",\"token\":\"caffè\"},\"name\":\"search\",\"category\":\"action\",\"token\":\"qual è\"}}";
