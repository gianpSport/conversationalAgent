...
public class DM121 extends DM000{
	
	String url = DM_AllTests.URL;
	float threshold = DM_AllTests.threshold;
	DialogManager dm;
	String message="In quali macchinette è possibile fare il cappuccino?";
	String result_message="{\"result\":[{\"name\":\"fantasia\"},{\"name\":\"fantasia plus\"},{\"name\":\"minù caffè latte\"}],\"query\":{\"domain\":{\"name\":\"machine\",\"property\":{\"name\":\"milkProgram\",\"category\":\"property\",\"value\":{\"name\":\"true_milkProgram\",\"category\":\"value\",\"token\":\"cappuccin\"}},\"category\":\"domain\",\"token\":\"macchinette\"},\"name\":\"search\",\"category\":\"action\",\"token\":\"quali\"}}{\"query\":{\"name\":\"text\",\"category\":\"extracted\",\"token\":\"è possibile fare\"}}";
