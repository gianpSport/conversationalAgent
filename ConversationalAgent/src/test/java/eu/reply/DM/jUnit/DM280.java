...
public class DM280 extends DM000{
	
	String url = DM_AllTests.URL;
	float threshold = DM_AllTests.threshold;
	DialogManager dm;
	String message="Le capsule Delizioso possono essere inserite in macchine di tutte le marche?";
	String result_message="{\"query\":{\"name\":\"text\",\"category\":\"extracted\",\"token\":\"possono\"}}{\"result\":{\"name\":\"lavazza delizioso\"},\"query\":{\"domain\":[{\"name\":\"capsule\",\"property\":[{\"name\":\"name capsule\",\"category\":\"property\",\"value\":{\"name\":\"lavazza delizioso\",\"category\":\"value\",\"token\":\"delizioso\"}},{\"name\":\"compatible\",\"category\":\"property\",\"token\":\"essere inserit\"}],\"category\":\"domain\",\"token\":\"capsule\"},{\"name\":\"machine\",\"property\":{\"name\":\"brand\",\"category\":\"property\",\"token\":\"marche\"},\"category\":\"domain\",\"token\":\"macchine\"}],\"name\":\"search\",\"category\":\"action\"}}{\"query\":{\"name\":\"text\",\"category\":\"extracted\",\"token\":\"tutte\"}}";
