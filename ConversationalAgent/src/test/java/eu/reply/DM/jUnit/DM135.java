...
public class DM135 extends DM000{
	
	String url = DM_AllTests.URL;
	float threshold = DM_AllTests.threshold;
	DialogManager dm;
	String message="Ci sono delle macchine che fanno anche i cappuccini?";
	String result_message="{\"result\":[{\"name\":\"fantasia\"},{\"name\":\"fantasia plus\"},{\"name\":\"minù caffè latte\"}],\"query\":{\"domain\":{\"name\":\"machine\",\"property\":{\"name\":\"milkProgram\",\"category\":\"property\",\"value\":{\"name\":\"true_milkProgram\",\"category\":\"value\",\"token\":\"cappuccin\"}},\"category\":\"domain\",\"token\":\"macchine\"},\"name\":\"search\",\"category\":\"action\",\"token\":\"ci sono\"}}{\"query\":{\"name\":\"text\",\"category\":\"extracted\",\"token\":\"fanno anche\"}}";
