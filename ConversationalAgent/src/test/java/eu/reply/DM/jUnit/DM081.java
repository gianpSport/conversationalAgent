...
public class DM081 extends DM000{
	
	String url = DM_AllTests.URL;
	float threshold = DM_AllTests.threshold;
	DialogManager dm;
	String message="Quante capsule ci sono in ogni confezione?";
	...
	String real_result="{\"result\":[{\"pack\":{\"quantity\":16}},{\"pack\":{\"quantity\":12}},{\"pack\":{\"quantity\":6}},{\"pack\":{\"quantity\":36}}]}";
